...
export const fallbackAgents: Agent[] = [
  {
    ...
    description: "Provides financial data, historical prices, dividends, market descriptions, and key financial metrics for stocks using Yahoo Finance.",
    capabilities: ["get historical stock prices", "get dividend and split history", "get market description", "get financial details"],
    ...
    endpoints: [
      {
        ...
        http_method: "POST", 
        description: "Returns historical OHLC prices for a given ticker, period, and interval."
      }
    ],
    rating: 4.2,
