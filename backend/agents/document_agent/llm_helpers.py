...
Domain-specific LLM methods for document operations.
All methods use inference_service directly.

Preserves ALL original functionality from DocumentLLMClient.
"""
import json
import re
import logging
...
class DocumentLLMHelpers:
    """
    Document-specific LLM helpers.
    
    Mix this into DocumentAgent to get document-specific LLM methods.
    All methods use inference_service directly (preserving original functionality).
    """
    
    # ========================================================================
    # PUBLIC API - PRESERVED FROM ORIGINAL DocumentLLMClient
    # ========================================================================
    ...
    async def interpret_edit_instruction(
        ...
        PRESERVED FROM ORIGINAL DocumentLLMClient - ALL FUNCTIONALITY INTACT
        """
        try:
...
Provide 3-5 sentence summary."""
    ...
    # ========================================================================
    # PRIVATE HELPER METHODS - PRESERVED FROM ORIGINAL DocumentLLMClient
    # ========================================================================
