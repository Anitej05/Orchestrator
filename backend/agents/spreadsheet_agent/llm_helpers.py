# agents/spreadsheet_agent/llm_helpers.py
"""
Spreadsheet Agent - LLM Helper Functions

Domain-specific LLM methods for spreadsheet operations.
All methods use BaseAgent's llm_* methods internally.

Preserves ALL original functionality from LLMClient.
"""
import json
import re
import logging
...
class SpreadsheetLLMHelpers:
    """
    Spreadsheet-specific LLM helpers.
    
    Mix this into SpreadsheetAgent to get spreadsheet-specific LLM methods.
    All methods use inference_service directly (preserving original functionality).
    """
    
    # ========================================================================
    # PUBLIC API - PRESERVED FROM ORIGINAL LLMClient
    # ========================================================================
    ...
    async def decompose_request(
        ...
        PRESERVED FROM ORIGINAL LLMClient - ALL FUNCTIONALITY INTACT
        """
...
{{
    ...
    async def analyze_excel_structure(
        ...
        PRESERVED FROM ORIGINAL LLMClient - ALL FUNCTIONALITY INTACT
        """
        structure_json = json.dumps(structure, indent=2, default=str)[:8000]
...
{{
    ...
    # ========================================================================
    # PRIVATE HELPER METHODS - PRESERVED FROM ORIGINAL LLMClient
    # ========================================================================
